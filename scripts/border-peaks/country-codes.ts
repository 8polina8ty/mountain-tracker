// ISO alpha-2 -> alpha-3 map for global ADM0 discovery.
// Includes the full ISO 3166-1 set plus Mountain Tracker's explicit XK/XKX exception.
export const GLOBAL_ISO2_TO_ISO3 = Object.freeze({
...
export type GlobalCountryCode = keyof typeof GLOBAL_ISO2_TO_ISO3;

export function iso3ForCountry(code: string): string | null {
  return (GLOBAL_ISO2_TO_ISO3 as Record<string, string>)[code] ?? null;
}
